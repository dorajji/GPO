...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': 'OEIS_TUSUR', #env('POSTGRES_DB'),
...
CKEDITOR_5_CUSTOM_CSS = 'backend\backend\static\styles\ckeditor5_styles.css' # optional
...
CKEDITOR_5_CONFIGS = {
   ...
   "extends": {
        ...
        'toolbar': ['undo','redo','|', 'heading', '|', 'outdent', 'indent', 'alignment', '|', 'bold', 'italic', 'link', 'underline', 'strikethrough',
